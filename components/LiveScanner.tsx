        ...
        <div className="fixed inset-0 bg-black z-50 flex flex-col">
                ...
                <div className="absolute top-8 left-0 right-0 flex flex-col items-center">
                    <div className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 flex items-center gap-3">
                        ...
                        <span className="text-white text-xs font-black tracking-widest uppercase">
                            {isAnalyzingFrame ? 'AI 正在辨識中...' : 'AR 雷達掃描中'}
                        </span>
                    </div>

                    <div className="mt-4 bg-white/10 backdrop-blur-lg px-6 py-3 rounded-2xl border border-white/10 flex flex-col items-center">
                        <span className="text-white/60 text-[10px] font-bold uppercase tracking-tighter">已捕獲商品</span>
                        <span className="text-white text-3xl font-black tabular-nums">{capturedCount}</span>
                    </div>
                </div>
            ...
            <div className="bg-slate-900 px-6 py-8 flex flex-col items-center gap-4">
                ...
                <button
                    ...
                    className="w-full bg-rose-500 hover:bg-rose-600 active:scale-95 text-white font-black py-4 rounded-2xl shadow-lg transition-all flex items-center justify-center gap-2"
                >
                    <i className="fas fa-stop-circle"></i> 停止掃描並產出報告
                </button>
            </div>
